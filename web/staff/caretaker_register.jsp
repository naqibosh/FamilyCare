...
<html lang="en">
    <head>
        ...
        <title>Family Care - Caretaker Registration</title>
        ...
        <style>
            body {
                background: url('../image/upload/happy-nurse-holding-elderly-man-hand-wheelchair-garden-nursing-home_554837-197.jpg') center/cover no-repeat;
            }
            .container {
                max-width: 600px;
            }
